...
def main():
    ...
    if st.button("Calculate Expenses"):
        ...
        if difference < 0:
            st.markdown("<h2 class='section-header'>Great news! Your expenses are ${:.2f} under your Future You limit. This means you are on track to achieving the future you want... with extra money to spare! <br><br> Consider adjusting your inputs in the Current You and Future You tools to see if you can get your expenses to match your Future You expense limit. For example, you could allocate some of your extra money to having fun, additional goals or leveling up your fixed expenses.</h2>".format(abs(difference)), unsafe_allow_html=True)
        elif difference == 0:
