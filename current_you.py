...
def main():
    ...
    if st.button("Calculate Expenses"):
        ...
        st.markdown(f"<h5 style='color: black;'>Total Monthly Expenses (Current You):<span style='color: #D22B2B;'><b> ${total_expenses:.2f}".format(difference), unsafe_allow_html=True)
        st.markdown(f"<h5 style='color: black;'>Expense Limit (Future You):<span style='color: indigo;'><b> ${future_you_limit:.2f}".format(difference), unsafe_allow_html=True)
