...
def main():
    ...
    if st.button("Calculate Expenses"):
        ...
        if difference < 0:
            st.markdown("<h2 class='section-header'>Great news! Your expenses are ${:.2f} under your Future You limit. This means you are on track to achieving the future you want with extra money to spare. Consider allocating some of your extra money to having fun, additional goals or leveling up your fixed expenses. Feel free to play around with your inputs in the Current You and Future You tools to see ways you can maximise enjoying life now while also achieving goals in the future!</h2>".format(abs(difference)), unsafe_allow_html=True)
        elif difference == 0:
